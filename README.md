...
Figgie was created by **Jane Street** as a teaching game for market intuition. This is an independent, open-source reimplementation of the *rules* for research and fun — no affiliation, no code, no assets from the original. If you've never played, [it's genuinely great](https://www.figgie.com/).
